...
var Catalog = []CatalogEntry{
	...
	// ---- STORY-098 log forwarding destination audit subjects (PAT-026 RECURRENCE)
	{
		Type:            "log_forwarding.destination_added",
		Source:          "settings",
		DefaultSeverity: severity.Info,
		EntityType:      "syslog_destination",
		Description:     "A new syslog forwarding destination was created via API-338 (STORY-098).",
		MetaSchema: map[string]string{
			"name":      "string",
			"host":      "string",
			"port":      "int",
	...
	{
		Type:            "log_forwarding.destination_updated",
		Source:          "settings",
		DefaultSeverity: severity.Info,
		EntityType:      "syslog_destination",
		Description:     "An existing syslog forwarding destination was updated via API-338 upsert (STORY-098).",
		MetaSchema: map[string]string{
			"name":      "string",
			"host":      "string",
			"port":      "int",
	...
	{
		Type:            "log_forwarding.destination_disabled",
		Source:          "settings",
		DefaultSeverity: severity.Info,
		EntityType:      "syslog_destination",
		Description:     "A syslog forwarding destination was disabled (STORY-098).",
		MetaSchema: map[string]string{
			"name":    "string",
			"enabled": "bool",
		},
	...
	{
		Type:            "log_forwarding.destination_deleted",
		Source:          "settings",
		DefaultSeverity: severity.Info,
		EntityType:      "syslog_destination",
		Description:     "A syslog forwarding destination was deleted (STORY-098).",
		MetaSchema:      map[string]string{},
		Tier:            "operational",
	},
	{
		Type:            "log_forwarding.delivery_failed",
		Source:          "notification",
		DefaultSeverity: severity.Medium,
		EntityType:      "syslog_destination",
		Description:     "Rate-limited audit row emitted by the syslog forwarder worker when send failures recur. Backoff: at most one row per destination per minute; suppressed_count carries the swallowed count between emits (STORY-098 AC-15, PAT-026 RECURRENCE Gate fix).",
		MetaSchema: map[string]string{
			"destination_id":   "uuid",
