-- FIX-245 T1 DOWN: Recreate kill_switches and maintenance_windows tables.
-- Reproduced from 20260416000001_admin_compliance.up.sql.
-- NOTE: Data is NOT restored on rollback — tables are recreated empty.
