...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sessions_state
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_sessions_acct_active
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_anomalies_tenant_detected
    ON anomalies (tenant_id, detected_at DESC, id DESC);

-- Anomalies: HasRecentAnomaly query filter
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_anomalies_tenant_sim_type_active
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_audit_tenant_id_desc
