...
INSERT INTO operator_grants (id, tenant_id, operator_id, enabled) VALUES
    -- XYZ Edaş
    ('00000000-0000-0000-0000-000000000201', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', true),
    ('00000000-0000-0000-0000-000000000202', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000102', true),
    ('00000000-0000-0000-0000-000000000203', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000103', true),
    -- ABC Edaş
    ('00000000-0000-0000-0000-000000000211', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000101', true),
    ('00000000-0000-0000-0000-000000000212', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000102', true),
    ('00000000-0000-0000-0000-000000000213', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000103', true)
...
INSERT INTO apns (id, tenant_id, operator_id, name, display_name, apn_type, supported_rat_types, state) VALUES
    -- XYZ Edaş APNs
    ('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', 'iot.xyz.local',     'XYZ IoT',     'iot', ARRAY['nb_iot','lte_m','lte'],        'active'),
    ('00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000102', 'm2m.xyz.local',     'XYZ M2M',     'm2m', ARRAY['lte','lte_m','nr_5g'],         'active'),
    ('00000000-0000-0000-0000-000000000303', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000103', 'private.xyz.local', 'XYZ Private', 'private', ARRAY['lte','lte_m'],             'active'),
    -- ABC Edaş APNs
    ('00000000-0000-0000-0000-000000000311', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000101', 'iot.abc.local',     'ABC IoT',     'iot', ARRAY['nb_iot','lte_m','lte'],        'active'),
    ('00000000-0000-0000-0000-000000000312', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000102', 'm2m.abc.local',     'ABC M2M',     'm2m', ARRAY['lte','lte_m','nr_5g'],         'active'),
    ('00000000-0000-0000-0000-000000000313', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000103', 'private.abc.local', 'ABC Private', 'private', ARRAY['lte','lte_m'],             'active')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO sims (id, tenant_id, operator_id, apn_id, iccid, imsi, msisdn, sim_type, state, rat_type, activated_at) VALUES
    ...
    ('00000000-0000-0000-0000-000000000701', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000301', '8990286010000100001001', '2860100001', '+905310000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000702', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000301', '8990286010000100002001', '2860100002', '+905310000002', 'physical', 'active', 'nb_iot', NOW()),
    ('00000000-0000-0000-0000-000000000703', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000301', '8990286010000100003001', '2860100003', '+905310000003', 'physical', 'active', 'lte_m',  NOW()),
    ('00000000-0000-0000-0000-000000000704', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000302', '8990286020000100004001', '2860200001', '+905320000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000705', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000302', '8990286020000100005001', '2860200002', '+905320000002', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000706', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000302', '8990286020000100006001', '2860200003', '+905320000003', 'physical', 'active', 'nr_5g',  NOW()),
    ('00000000-0000-0000-0000-000000000707', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000303', '8990286030000100007001', '2860300001', '+905330000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000708', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000303', '8990286030000100008001', '2860300002', '+905330000002', 'physical', 'active', 'lte_m',  NOW()),
    -- ABC Edaş (tenant_digit=2) — 8 SIMs: 3 Turkcell + 3 Vodafone + 2 Türk Telekom
    ('00000000-0000-0000-0000-000000000711', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000311', '8990286010000200001001', '2860100021', '+905410000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000712', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000311', '8990286010000200002001', '2860100022', '+905410000002', 'physical', 'active', 'nb_iot', NOW()),
    ('00000000-0000-0000-0000-000000000713', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000311', '8990286010000200003001', '2860100023', '+905410000003', 'physical', 'active', 'lte_m',  NOW()),
    ('00000000-0000-0000-0000-000000000714', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000312', '8990286020000200004001', '2860200021', '+905420000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000715', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000312', '8990286020000200005001', '2860200022', '+905420000002', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000716', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000312', '8990286020000200006001', '2860200023', '+905420000003', 'physical', 'active', 'nr_5g',  NOW()),
    ('00000000-0000-0000-0000-000000000717', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000313', '8990286030000200007001', '2860300021', '+905430000001', 'physical', 'active', 'lte',    NOW()),
    ('00000000-0000-0000-0000-000000000718', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000313', '8990286030000200008001', '2860300022', '+905430000002', 'physical', 'active', 'lte_m',  NOW())
