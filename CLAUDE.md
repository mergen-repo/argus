...
- Story: — (Wave 10 1/6 DONE — FIX-240 closed; FIX-246 next)
- Step: —
- Last closed: FIX-240 [x] DONE 2026-04-27 (Wave 10 P2 M — Unified Settings Page + Tabbed Reorganization; F-231/232/233-out/234/235/236 consolidation; new /settings tabbed shell + useHashTab hook + RBAC helper extracted to lib/rbac.ts + 5 tab components (security/sessions/reliability/notifications/preferences) + Notifications Simple/Advanced toggle catalog-driven via FIX-212 /events/catalog + 4 old routes 301-redirect via React Router Navigate + sidebar SETTINGS group 8→3 items + Knowledge Base moved from OPERATIONS → SETTINGS + 4 legacy /settings/{security,sessions,reliability,notifications}.tsx deleted; 4 type-level smoke test files (14 scenarios); Gate fixes: aria-label mobile Select + dead ROLE_LEVELS import + 2 legacy-path redirect-hop polish (command-palette + system/health); DEV-565 grouping axis source vs category; SCREENS.md routes updated SCR-019/113/115/134/191; ARCHITECTURE.md route table updated; ui-review F-231..F-236 closure-stamped; 8 USERTEST scenarios; 16 files +88/-1511 net (4 legacy pages -1456); tsc 0 errors; vite build 2.77s)
- Wave 10 P2 IN PROGRESS (1/6 — FIX-240 DONE; FIX-246/235/245/238/247 PENDING)
