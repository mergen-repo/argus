...
│                                                                │
│ ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌──────────┐            │
│ │ SVC-01  │ │ SVC-02  │ │ SVC-04  │ │ SVC-04   │            │
│ │ API GW  │ │ WS Srv  │ │ RADIUS  │ │ Diameter │            │
│ │ :8080   │ │ :8081   │ │ :1812/13│ │ :3868    │            │
│ └────┬────┘ └────┬────┘ └────┬────┘ └────┬─────┘            │
│      │           │           │            │                    │
│ ┌────▼───────────▼───────────▼────────────▼─────────────────┐│
│ │                 INTERNAL PACKAGES                          ││
...
| [architecture/api/](architecture/api/_index.md) | API surface (104 endpoints + story links) |
